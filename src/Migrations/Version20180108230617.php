 ...
 */
class Version20180108230617 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE tipo_vuln ADD COLUMN detalle VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE tipo_vuln ADD COLUMN mitigacion VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP TABLE __temp__plataforma');
        $this->addSql('CREATE INDEX IDX_A0FE8A1E53C59D72 ON plataforma (responsable_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__tipo_vuln AS SELECT id, descripcion, criticidad, id_serpico FROM tipo_vuln');
        $this->addSql('DROP TABLE tipo_vuln');
        $this->addSql('CREATE TABLE tipo_vuln (id INTEGER NOT NULL, descripcion VARCHAR(255) NOT NULL, criticidad INTEGER NOT NULL, id_serpico INTEGER DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO tipo_vuln (id, descripcion, criticidad, id_serpico) SELECT id, descripcion, criticidad, id_serpico FROM __temp__tipo_vuln');
        $this->addSql('DROP TABLE __temp__tipo_vuln');
        $this->addSql('DROP INDEX IDX_EE34EB96A9276E6C');
        $this->addSql('DROP INDEX IDX_EE34EB96F7A6D53B');
        $this->addSql('CREATE TEMPORARY TABLE __temp__vulnerabilidad AS SELECT id, tipo_id, escaneo_id, estado, fecha_creacion, fecha_modificacion, comentario FROM vulnerabilidad');
        $this->addSql('DROP TABLE vulnerabilidad');
